...
func (m *TradingSessionManagerImpl) DeleteTradingSession(sessionId string) {
	//TODO
}

func (m *TradingSessionManagerImpl) FindTradingSession(sessionId string) TradingSession {
	//TODO
	return CreateTradingSession(ContinousMarket)
}

func (m *TradingSessionManagerImpl) Init() {
	//TODO
}
